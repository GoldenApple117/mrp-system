...
def seed_demo_data():
    ...
    materials = [
        ...
        MaterialMaster(material_code="FG-001", material_name="智能温控器", unit="台", material_type="成品",
                       level_type="产品", lead_time=5, safety_stock=10, lot_size_rule="LFL", is_purchased=False, scrap_rate=1),
        MaterialMaster(material_code="FG-002", material_name="电动阀门", unit="台", material_type="成品",
                       level_type="产品", lead_time=7, safety_stock=8, lot_size_rule="FOQ", lot_size_qty=30, is_purchased=False),
        MaterialMaster(material_code="FG-003", material_name="工业传感器模组", unit="套", material_type="成品",
                       level_type="产品", lead_time=10, safety_stock=5, lot_size_rule="LFL", is_purchased=False),
        ...
        MaterialMaster(material_code="SA-001", material_name="温控主板组件", unit="个", material_type="半成品",
                       level_type="零件", lead_time=3, safety_stock=15, lot_size_rule="FOQ", lot_size_qty=50, is_purchased=False),
        MaterialMaster(material_code="SA-002", material_name="显示面板组件", unit="个", material_type="半成品",
                       level_type="零件", lead_time=2, safety_stock=12, lot_size_rule="LFL", is_purchased=False),
        MaterialMaster(material_code="SA-003", material_name="阀门执行器组件", unit="个", material_type="半成品",
                       level_type="零件", lead_time=4, safety_stock=10, lot_size_rule="FOQ", lot_size_qty=40, is_purchased=False),
        MaterialMaster(material_code="SA-004", material_name="传感器核心模块", unit="个", material_type="半成品",
                       level_type="零件", lead_time=5, safety_stock=8, lot_size_rule="FOQ", lot_size_qty=30, is_purchased=False),
        MaterialMaster(material_code="RM-001", material_name="PCB电路板", unit="块", material_type="原材料",
                       level_type="零件", lead_time=5, safety_stock=30, lot_size_rule="EOQ", lot_size_qty=500, is_purchased=True),
        MaterialMaster(material_code="RM-002", material_name="温度传感器芯片", unit="个", material_type="原材料",
                       level_type="零件", lead_time=7, safety_stock=50, lot_size_rule="EOQ", lot_size_qty=1000, is_purchased=True),
        MaterialMaster(material_code="RM-003", material_name="LCD显示屏", unit="块", material_type="原材料",
                       level_type="零件", lead_time=10, safety_stock=25, lot_size_rule="FOQ", lot_size_qty=100, is_purchased=True),
        MaterialMaster(material_code="RM-004", material_name="微型步进电机", unit="个", material_type="原材料",
                       level_type="零件", lead_time=4, safety_stock=20, lot_size_rule="FOQ", lot_size_qty=200, is_purchased=True),
        MaterialMaster(material_code="RM-005", material_name="铝合金外壳", unit="个", material_type="原材料",
                       level_type="零件", lead_time=3, safety_stock=20, lot_size_rule="MULT", lot_size_qty=100, is_purchased=True),
        MaterialMaster(material_code="RM-006", material_name="电源模块12V", unit="个", material_type="原材料",
                       level_type="零件", lead_time=6, safety_stock=40, lot_size_rule="EOQ", lot_size_qty=300, is_purchased=True),
        MaterialMaster(material_code="RM-007", material_name="不锈钢阀体", unit="个", material_type="原材料",
                       level_type="零件", lead_time=8, safety_stock=15, lot_size_rule="FOQ", lot_size_qty=50, is_purchased=True),
        MaterialMaster(material_code="RM-008", material_name="密封圈套件", unit="套", material_type="原材料",
                       level_type="零件", lead_time=2, safety_stock=50, lot_size_rule="MULT", lot_size_qty=500, is_purchased=True),
        MaterialMaster(material_code="RM-009", material_name="工业级传感器探头", unit="个", material_type="原材料",
                       level_type="零件", lead_time=12, safety_stock=20, lot_size_rule="FOQ", lot_size_qty=80, is_purchased=True),
    ]
