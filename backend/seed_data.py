...
def seed_demo_data():
    ...
    materials = [
        ...
        MaterialMaster(material_code="FG-003", material_name="工业传感器模组", unit="套", material_type="成品",
                       lead_time=10, safety_stock=10, lot_size_rule="LFL", is_purchased=False),
        ...
        MaterialMaster(material_code="SA-004", material_name="传感器核心模块", unit="个", material_type="半成品",
                       lead_time=5, safety_stock=15, lot_size_rule="FOQ", lot_size_qty=30, is_purchased=False),
        ...
        MaterialMaster(material_code="RM-009", material_name="工业级传感器探头", unit="个", material_type="原材料",
                       lead_time=12, safety_stock=50, lot_size_rule="FOQ", lot_size_qty=80, is_purchased=True),
    ]
