...
class MaterialMaster(Base):
    ...
    reference_unit_price = Column(Float, default=0, comment="参考单价")
    reference_submitter = Column(String(50), default="", comment="参考提交人")
    reference_link = Column(String(1000), default="", comment="参考采购链接")
